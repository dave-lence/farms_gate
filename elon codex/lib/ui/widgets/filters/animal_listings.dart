...
class AnimalListingsWidget extends StatefulWidget {
  const AnimalListingsWidget(
      {super.key,
  ...
  @override
  State<AnimalListingsWidget> createState() => _AnimalListingsWidgetState();
}

class _AnimalListingsWidgetState extends State<AnimalListingsWidget> {
                  ...
                  child: FutureBuilder<List<ProductModel>>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        final animalProducts = snapshot.data!
                            .where((product) =>
                                product.category!.toLowerCase() == "animal")
                            .toList();

                        if (animalProducts.isEmpty) {
                          return const Center(
                            heightFactor: 4,
                            child: Text('No products found under "Animals".'),
                          );
                        }
                          ...
                          child: SizedBox(
                            ...
                            child: GridView.builder(
                              ...
                              itemBuilder: (context, productIndex) {
                                final product = animalProducts[productIndex];
                                return SizedBox(
                                  width: 156,
