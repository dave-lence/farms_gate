...
class CropsListingsWidget extends StatefulWidget {
  const CropsListingsWidget(
      {super.key,
  ...
  @override
  State<CropsListingsWidget> createState() => _CropsListingsWidgetState();
}

class _CropsListingsWidgetState extends State<CropsListingsWidget> {
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        final cropProducts = snapshot.data!
                            .where((product) =>
                                product.category!.toLowerCase() == "crop")
                            .toList();

                        if (cropProducts.isEmpty) {
                          return const Center(
                            child: Text('No products found under crops.'),
                          );
                        }
